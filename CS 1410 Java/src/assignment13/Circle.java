...
public class Circle extends Shape
{
     ...
     * color of this circle object.  The position is a point that
     * describes a box that contains this circle.  The point is
    ...
    public Circle (int x, int y, int diameter, Color color)
    {
    	...
    	this.radius = diameter / 2;  // Preserve the diameter.
    }
