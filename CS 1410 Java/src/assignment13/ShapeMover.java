    	...
    	shapes = new Shape[]
    	    {
                ...
                new Rect    (230,  40,  20, 140, Color.BLUE),
                new Rect    (330,  40,  80, 80, Color.GREEN.darker()),
                new Rect    (130, 270, 100, 20, Color.ORANGE),
    	        new Rect    ( 30, 140,  40, 60, Color.YELLOW),
                new Circle  (470,  360,  60,  Color.RED),
                new Circle  (370,  360,  20,  Color.BLUE),
                new Circle    (270,  360,  80,  Color.GREEN.darker()),
                new Circle    (470, 460, 100, Color.ORANGE),
                new Circle    ( 570, 460,  40,  Color.YELLOW),
                new RegularPolygon      (300,300,40,7, Color.CYAN.darker()),
                new RegularPolygon      (470,440,80,3, Color.ORANGE),
                new RegularPolygon      (100,570,60,12, Color.RED)
    	    };
